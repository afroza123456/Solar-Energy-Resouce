        ...
        [20], {
            "3Csl": function(E, g, u) {
                ...
                const h = .05,
                    ...
                    S = ({
                        lcpImgWidthDelta: t = 0,
                        lcpImgHeightDelta: e = 0
                    }) => t + e,
                    H = ({
                        entries: t = []
                    }, e) => {
                        ...
                        const {
                            url: n,
                            element: l
                        } = (t == null ? void 0 : t.pop()) || {}, s = (l == null ? void 0 : l.className) || "unknown", i = (l == null || (o = l.tagName) === null || o === void 0 ? void 0 : o.toLowerCase()) || "", d = v(l), c = i === "img";
                        let r = {
                            lcpSelector: s,
                            lcpElementType: i,
                            lcpCustomType: d
                        };
                        const a = (l == null ? void 0 : l.clientWidth) || e,
                            m = !c && i !== "video";
                        return a && n && (r = Object.assign({}, r, w(a, n, m))), !m && n && c && (r = Object.assign({}, r, N(l))), Object.assign({}, r, {
                            lcpTotalImageDelta: S(r)
                        })
                    },
                    L = (t, {
                        viewportWidth: e
